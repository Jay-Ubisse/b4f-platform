...
import { NewCourseSheet } from "@/components/sheets/new-course-sheet";
...
export const CoursesTable = () => {
  ...
  return (
    <div className="mt-8">
      <Header t={t} count={courses?.length ?? 0} />
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {count} {count === 1 ? t("Header.Course") : t("Header.courses")}
              </p>
            </div>
          </div>
        </div>
